...
public class LuminatiProxyStrategy implements ProxyStrategy {
    ...
    public void addCollectionTask(CollectionTaskRequest collectionTaskRequest) {
        ...
        RBlockingQueue<CollectionTaskRequest> queue =
            redissonClient.getBlockingQueue(com.example.lpm.v3.constant.RedisKeyConstant.COLLECTION_TASK_TOPIC
        ...
        RAtomicLong collectFlag =
            redissonClient.getAtomicLong(com.example.lpm.v3.constant.RedisKeyConstant.COLLECTION_TASK_FLAG
                + collectionTaskRequest.getProxyIpType().getTypeName());
        // 开始 10
        collectFlag.set(10L);
        ...
        RAtomicLong currentNum =
            redissonClient.getAtomicLong(com.example.lpm.v3.constant.RedisKeyConstant.COLLECTION_TASK_CURRENT
                + collectionTaskRequest.getProxyIpType().getTypeName());
        ...
        redisTemplate.delete(com.example.lpm.v3.constant.RedisKeyConstant.COLLECTION_TASK_ERROR
            + collectionTaskRequest.getProxyIpType().getTypeName());
    }
